...
def normalize_context(
    name: str | None, username: str | None, organization: str | None, role: str | None = None, department: str | None = None
) -> TextContext:
    """Trim each optional field and enforce the normalized character limit."""
    values = {}
    for field, value in (
        ("name", name), ("username", username), ("organization", organization), ("role", role), ("department", department)
    ):
