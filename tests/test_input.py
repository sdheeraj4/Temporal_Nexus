...
class InputEndpointTests(unittest.TestCase):
    ...
    def test_valid_png_and_normalized_context(self):
        ...
        self.assertEqual(body, {
            "status": "validated",
            "context": {"name": "Test", "username": "demo", "organization": None},
    ...
    def test_valid_jpeg(self):
        ...
        self.assertEqual(body["context"], {"name": None, "username": None, "organization": None})
    ...
    def test_exact_text_limit_after_trimming(self):
        fields = {field: "  " + "x" * 200 + "  " for field in ("name", "username", "organization")}
